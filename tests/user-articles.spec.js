...
test('Own article 1: QAOA for Max-Cut (English)', async () => {
  await runTestCase(
    {
...
test('Own article 2: Q# random numbers (Ukrainian)', async () => {
  await runTestCase(
    {
...
test('Own article 3: Quantum transpilation (Ukrainian)', async () => {
  await runTestCase(
    {
