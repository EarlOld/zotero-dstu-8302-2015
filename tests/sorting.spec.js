  ...
  await runTestCase(
    {
      ...
      data: {
        items: {
          ...
          "ITEM-UK4": {
            id: "ITEM-UK4",
            title:
              "Економічні та промислові застосування квантових компʼютерів",
            author: [
            ...
            language: "uk",
            "event-title":
              "Тези Всеукраїнської науково-практичної інтернет-конференції студентів, аспірантів та молодих вчених",
      ...
      expected:
        "1. Петренко І. І. Українське джерело. Київ : Видавництво. 2020. 100 с.\n\n  2. Сапожник Д. О., Морозов А. В. Економічні та промислові застосування квантових компʼютерів. 2022. P. 113–116.\n\n  3. Smith J. English source. London : Publisher. 2020. 150 с.",
    },
    expect,
  );
});
